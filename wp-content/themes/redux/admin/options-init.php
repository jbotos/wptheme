...
if (!class_exists('redux_Redux_Framework_config')) {

    class redux_Redux_Framework_config {
        ...
        public function setSections() {
            ...
            $this->sections[] = array(
                'title'     => __('Branding Settings', 'redux-framework-demo'),
...
// SOCIAL ICONS -> Setup custom links in the footer for quick links in your panel footer icons.
    ...
    global $reduxConfig;
    $reduxConfig = new redux_Redux_Framework_config();
}
